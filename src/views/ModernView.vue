<template>
  <div class="app-container">
    ...
    <!-- Десктопный хедер (виден только на десктопе) -->
    ...
    <!-- Мобильный хедер (виден только на мобилке) -->
...
/* --- Desktop Header (только для десктопа) --- */
.desktop-header {
...
/* --- Mobile адаптация (все мобильные стили внутри этого медиа-запроса) --- */
